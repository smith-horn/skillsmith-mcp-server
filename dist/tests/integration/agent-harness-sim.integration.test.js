...
describe.skipIf(skipInPrePush)('SMI-5456 L2a — agent harness-simulation MCP client', () => {
    ...
    describe.each(HARNESS_CASES)('harness: $id', ({ id, clientInfo }) => {
        ...
        function requireConnection() {
            if (!connection) {
                throw new Error(`harness ${id}: connection was never established (beforeAll must have thrown or timed out)`);
            }
            return connection;
        }
        afterAll(async () => {
...
//# sourceMappingURL=agent-harness-sim.integration.test.js.map