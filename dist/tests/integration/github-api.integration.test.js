...
describe.skipIf(SKIP_GITHUB_TESTS)('SMI-798: GitHub API Integration', () => {
    ...
    describe('Repository Search', () => {
        it('should search for claude-skill repositories', async () => {
            const response = await fetch('https://api.github.com/search/repositories?q=topic:claude-skill&per_page=5', {
                headers: {
    ...
    describe('File Content Retrieval', () => {
        it('should fetch README from a public repository', async () => {
            const response = await fetch('https://api.github.com/repos/anthropics/anthropic-cookbook/readme', {
                headers: {
                    Accept: 'application/vnd.github.v3+json',
                    ...(GITHUB_TOKEN ? { Authorization: `token ${GITHUB_TOKEN}` } : {}),
                },
        ...
        it('should handle missing files gracefully', async () => {
            const response = await fetch('https://api.github.com/repos/anthropics/anthropic-cookbook/contents/NONEXISTENT_FILE.md', {
                headers: {
                    Accept: 'application/vnd.github.v3+json',
                    ...(GITHUB_TOKEN ? { Authorization: `token ${GITHUB_TOKEN}` } : {}),
                },
    ...
    describe('Topic Search', () => {
        it('should search for repositories by topic', async () => {
            ...
            for (const topic of topics) {
                const response = await fetch(`https://api.github.com/search/repositories?q=topic:${topic}&per_page=3`, {
                    headers: {
                        Accept: 'application/vnd.github.v3+json',
                        ...(GITHUB_TOKEN ? { Authorization: `token ${GITHUB_TOKEN}` } : {}),
                    },
...
//# sourceMappingURL=github-api.integration.test.js.map