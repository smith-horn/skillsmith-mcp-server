...
describe('Search Tool Integration Tests', () => {
    ...
    describe('Search with Filters', () => {
        ...
        it('should filter by minimum quality score', () => {
            ...
            for (const result of results.items) {
                expect(result.skill.qualityScore).toBeGreaterThanOrEqual(0.9);
            }
        });
    ...
    describe('Search by Tags', () => {
        it('should find skills by tag content', () => {
            ...
            const hasJestTag = results.items.some((r) => r.skill.tags.some((tag) => tag.toLowerCase().includes('jest')));
    ...
    describe('Search by Author', () => {
        it('should find skills by author name', () => {
            ...
            const hasAnthropicAuthor = results.items.some((r) => r.skill.author?.toLowerCase() === 'anthropic');
