...
import { executeRecommend, formatRecommendations, recommendInputSchema, } from '../src/tools/recommend.js';
import { createTestDatabase } from './integration/setup.js';
...
describe('Skill Recommend Tool', () => {
    describe('recommendInputSchema', () => {
        ...
        it('should enforce limit bounds', () => {
            expect(() => recommendInputSchema.parse({
                installed_skills: [],
                limit: 0,
            })).toThrow();
            expect(() => recommendInputSchema.parse({
    ...
    describe('executeRecommend', () => {
        ...
        it('should include trust tier and quality score', async () => {
            ...
            for (const rec of result.recommendations) {
                ...
                expect(['verified', 'community', 'experimental', 'unknown', 'local']).toContain(rec.trust_tier);
        ...
        it('should use project_context for better recommendations', async () => {
            ...
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            (name) => name.toLowerCase().includes('react') ||
    ...
    describe('formatRecommendations', () => {
        ...
        it('should display trust badges', async () => {
            ...
            const hasBadge = formatted.includes('[VERIFIED]') ||
