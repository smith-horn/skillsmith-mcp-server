...
`;
            ...
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            (e) => e.field === 'description' && e.severity === 'warning')).toBe(true);
        });
...
`;
            ...
            expect(result.errors.some(
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            (e) => e.field === 'description' && e.severity === 'error')).toBe(true);
        });
...
`;
            ...
            expect(result.errors.some(
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            (e) => e.field === 'name' && e.message.includes('exceeds maximum length'))).toBe(true);
        });
...
`;
            ...
            expect(result.errors.some(
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            (e) => e.field === 'description' && e.message.includes('exceeds maximum length'))).toBe(true);
        });
...
`;
            ...
            expect(result.errors.some(
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            (e) => e.field === 'repository' && e.message.includes('dangerous URL pattern'))).toBe(true);
        });
...
`;
            ...
            expect(result.errors.some(
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            (e) => e.field === 'tags' && e.message.includes('array'))).toBe(true);
        });
...
`;
            ...
            expect(result.errors.some(
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            (e) => e.field.startsWith('tags[') && e.message.includes('exceeds'))).toBe(true);
        });
    });
