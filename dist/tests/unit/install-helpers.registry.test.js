...
describe('install.helpers (registry + fetch)', () => {
    ...
    describe('fetchFromGitHub', () => {
        ...
        it('fetches file from main branch', async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith('https://raw.githubusercontent.com/owner/repo/main/SKILL.md', expect.objectContaining({ signal: expect.any(AbortSignal) }));
        });
        it('fetches from specified branch', async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith('https://raw.githubusercontent.com/owner/repo/develop/file.md', expect.objectContaining({ signal: expect.any(AbortSignal) }));
        });
        it('falls back to master when main fails', async () => {
            ...
            expect(mockFetch).toHaveBeenLastCalledWith('https://raw.githubusercontent.com/owner/repo/master/SKILL.md', expect.objectContaining({ signal: expect.any(AbortSignal) }));
        });
...
//# sourceMappingURL=install-helpers.registry.test.js.map