...
import { parseSkillId, parseRepoUrl, validateSkillMd, generateTips, acquireManifestLock, releaseManifestLock, loadManifest, saveManifest, updateManifestSafely, assertNotEncrypted, } from '../../src/tools/install.helpers.js';
// Mock fs module
vi.mock('fs/promises');
