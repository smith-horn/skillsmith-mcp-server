...
import { bootstrapUnmanagedSkills, detectCollisions, getLastBootstrapWarnings, isUnmanagedSkill, } from '../../src/audit/collision-detector.js';
...
describe('semantic pass — power_user mode', () => {
    ...
    it('skips semantic pairs already flagged by the exact pass', async () => {
        ...
        const semanticPaths = result.semanticCollisions.map((f) => [f.entryA.source_path, f.entryB.source_path].sort().join('|'));
...
//# sourceMappingURL=collision-detector.semantic.test.js.map