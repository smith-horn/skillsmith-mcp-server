...
import { appendOverride, findOverride, readLedger, readLedgerResult, writeLedger, } from '../../src/audit/namespace-overrides.js';
...
function makeOverrideInput(overrides = {}) {
    return {
...
describe('appendOverride', () => {
    it('returns a new ledger; the input is not mutated', () => {
        const initial = { version: CURRENT_VERSION, overrides: [] };
...
describe('findOverride', () => {
    it('returns the matching record when (skillId, kind, originalIdentifier) all match', () => {
        let ledger = { version: CURRENT_VERSION, overrides: [] };
    ...
    it('returns null when no match exists', () => {
        const ledger = { version: CURRENT_VERSION, overrides: [] };
...
//# sourceMappingURL=namespace-overrides.test.js.map