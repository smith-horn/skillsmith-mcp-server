...
import { parseSkillMd, getSkillIdFromDir, getInstalledSkills, getInstalledSkillsSync, getInstalledSkillsDetailed, } from '../../src/utils/installed-skills.js';
 ...
 */
function createTestSkill(name, skillMdContent) {
...
# Missing Name`;
        ...
        it('should fall back to directory name when SKILL.md is invalid', () => {
            ...
            fs.writeFileSync(path.join(TEST_TEMP_DIR, 'invalid-md', 'SKILL.md'), 'Not valid frontmatter content');
    ...
    describe('getInstalledSkills', () => {
        ...
        it('should detect skills with SKILL.md', async () => {
            createTestSkill('docker', `---
name: docker
description: Docker skill
---
# Docker`);
            createTestSkill('varlock', `---
name: varlock
...
# Custom`);
        ...
        it('should skip hidden directories', async () => {
            createTestSkill('.hidden-skill', `---
name: hidden
---
# Hidden`);
            createTestSkill('visible-skill', `---
name: visible
---
# Visible`);
            const result = await getInstalledSkills(TEST_TEMP_DIR);
...
# Sync`);
    ...
    describe('getInstalledSkillsDetailed', () => {
        ...
        it('should return detailed skill information', async () => {
            createTestSkill('detailed-skill', `---
name: detailed
...
//# sourceMappingURL=installed-skills.test.js.map