...
import { auditExportInputSchema, executeAuditExport, auditQueryInputSchema, executeAuditQuery, siemExportInputSchema, executeSiemExport, } from './tools/audit-tools.js';
import { teamWorkspaceInputSchema, executeTeamWorkspace, shareSkillInputSchema, executeShareSkill, } from './tools/team-workspace.js';
import { publishPrivateInputSchema, executePublishPrivate } from './tools/publish-private.js';
import { teamAnalyticsDashboardInputSchema, executeTeamAnalyticsDashboard, teamUsageReportInputSchema, executeTeamUsageReport, analyticsDashboardInputSchema, executeAnalyticsDashboard, usageReportInputSchema, executeUsageReport, } from './tools/analytics.js';
import { configureSsoInputSchema, executeConfigureSso, ssoSettingsInputSchema, executeSsoSettings, } from './tools/sso-tools.js';
import { privateRegistryPublishInputSchema, executePrivateRegistryPublish, privateRegistryManageInputSchema, executePrivateRegistryManage, } from './tools/registry-tools.js';
import { rbacManageInputSchema, executeRbacManage, rbacAssignRoleInputSchema, executeRbacAssignRole, rbacCreatePolicyInputSchema, executeRbacCreatePolicy, } from './tools/rbac-tools.js';
import { webhookConfigureInputSchema, executeWebhookConfigure, apiKeyManageInputSchema, executeApiKeyManage, } from './tools/integration-tools.js';
...
import { ok, errResponse, withLicenseAndQuota, TOOL_FEATURES, FEATURE_TIERS, } from './middleware/license.js';
...
export async function dispatchToolCall(name, args, toolContext, licenseMiddleware, quotaMiddleware) {
    switch (name) {
        ...
        case 'skill_updates':
            return withLicenseAndQuota('skill_updates', args, skillUpdatesInputSchema, executeSkillUpdates, toolContext, licenseMiddleware, quotaMiddleware);
        case 'skill_diff':
            return withLicenseAndQuota('skill_diff', args, skillDiffInputSchema, executeSkillDiff, toolContext, licenseMiddleware, quotaMiddleware);
        case 'skill_audit':
        ...
        case 'audit_export':
            return withLicenseAndQuota('audit_export', args, auditExportInputSchema, executeAuditExport, toolContext, licenseMiddleware, quotaMiddleware);
        case 'audit_query':
            return withLicenseAndQuota('audit_query', args, auditQueryInputSchema, executeAuditQuery, toolContext, licenseMiddleware, quotaMiddleware);
        case 'siem_export':
            return withLicenseAndQuota('siem_export', args, siemExportInputSchema, executeSiemExport, toolContext, licenseMiddleware, quotaMiddleware);
        case 'team_workspace':
            return withLicenseAndQuota('team_workspace', args, teamWorkspaceInputSchema, executeTeamWorkspace, toolContext, licenseMiddleware, quotaMiddleware);
        case 'share_skill':
            return withLicenseAndQuota('share_skill', args, shareSkillInputSchema, executeShareSkill, toolContext, licenseMiddleware, quotaMiddleware);
        case 'publish_private':
            return withLicenseAndQuota('publish_private', args, publishPrivateInputSchema, executePublishPrivate, toolContext, licenseMiddleware, quotaMiddleware);
        case 'team_analytics_dashboard':
            return withLicenseAndQuota('team_analytics_dashboard', args, teamAnalyticsDashboardInputSchema, executeTeamAnalyticsDashboard, toolContext, licenseMiddleware, quotaMiddleware);
        case 'team_usage_report':
            return withLicenseAndQuota('team_usage_report', args, teamUsageReportInputSchema, executeTeamUsageReport, toolContext, licenseMiddleware, quotaMiddleware);
        case 'analytics_dashboard':
            return withLicenseAndQuota('analytics_dashboard', args, analyticsDashboardInputSchema, executeAnalyticsDashboard, toolContext, licenseMiddleware, quotaMiddleware);
        case 'usage_report':
            return withLicenseAndQuota('usage_report', args, usageReportInputSchema, executeUsageReport, toolContext, licenseMiddleware, quotaMiddleware);
        case 'configure_sso':
            return withLicenseAndQuota('configure_sso', args, configureSsoInputSchema, executeConfigureSso, toolContext, licenseMiddleware, quotaMiddleware);
        case 'sso_settings':
            return withLicenseAndQuota('sso_settings', args, ssoSettingsInputSchema, executeSsoSettings, toolContext, licenseMiddleware, quotaMiddleware);
        case 'private_registry_publish':
            return withLicenseAndQuota('private_registry_publish', args, privateRegistryPublishInputSchema, executePrivateRegistryPublish, toolContext, licenseMiddleware, quotaMiddleware);
        case 'private_registry_manage':
            return withLicenseAndQuota('private_registry_manage', args, privateRegistryManageInputSchema, executePrivateRegistryManage, toolContext, licenseMiddleware, quotaMiddleware);
        case 'rbac_manage':
            return withLicenseAndQuota('rbac_manage', args, rbacManageInputSchema, executeRbacManage, toolContext, licenseMiddleware, quotaMiddleware);
        case 'rbac_assign_role':
            return withLicenseAndQuota('rbac_assign_role', args, rbacAssignRoleInputSchema, executeRbacAssignRole, toolContext, licenseMiddleware, quotaMiddleware);
        case 'rbac_create_policy':
            return withLicenseAndQuota('rbac_create_policy', args, rbacCreatePolicyInputSchema, executeRbacCreatePolicy, toolContext, licenseMiddleware, quotaMiddleware);
        case 'webhook_configure':
            return withLicenseAndQuota('webhook_configure', args, webhookConfigureInputSchema, executeWebhookConfigure, toolContext, licenseMiddleware, quotaMiddleware);
        case 'api_key_manage':
            return withLicenseAndQuota('api_key_manage', args, apiKeyManageInputSchema, executeApiKeyManage, toolContext, licenseMiddleware, quotaMiddleware);
        case 'compliance_report':
            return withLicenseAndQuota('compliance_report', args, complianceReportInputSchema, executeComplianceReport, toolContext, licenseMiddleware, quotaMiddleware);
        default: {
