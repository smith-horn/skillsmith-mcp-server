 ...
 */
async function fetchConsentState(installId) {
 ...
 */
export function resolveConsent(anonymousId, fetchState = fetchConsentState) {
    if (!anonymousId) {
    ...
    const promise = fetchState(anonymousId).catch((error) => {
 ...
 */
export function wasConsentPrompted(anonymousId) {
    if (!anonymousId)
        return false;
 ...
 */
export function markConsentPrompted(anonymousId) {
    if (!anonymousId)
        return;
