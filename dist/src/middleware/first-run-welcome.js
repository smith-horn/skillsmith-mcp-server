 ...
 */
export function setPendingWelcome(message, failures) {
 ...
 */
export function annotateResponseWithWelcome(response) {
    if (!pendingWelcome)
        return response;
    if (response.isError)
        return response;
 ...
 */
export function _resetPendingWelcomeForTests() {
    pendingWelcome = null;
}
