 ...
 */
export declare function setPendingWelcome(message: string, failures: string[]): void;
/**
 ...
 */
export declare function hasPendingWelcome(): boolean;
/**
 ...
 */
export declare function annotateResponseWithWelcome(response: CallToolResult): CallToolResult;
/**
 ...
 */
export declare function _resetPendingWelcomeForTests(): void;
//# sourceMappingURL=first-run-welcome.d.ts.map