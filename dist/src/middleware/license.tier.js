...
export function createTierResolver(context, cacheTtlMs) {
    ...
    function handleTransientFailure(reason) {
        ...
        if (stale) {
            ...
            console.warn(`[skillsmith] SMI-1953 live tier check failed (${reason}); serving stale-cached ` +
        ...
        context.cacheExpiry = shortExpiry;
        console.warn(`[skillsmith] SMI-1953 live tier check failed (${reason}) with no prior cache; ` +
