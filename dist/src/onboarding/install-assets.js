...
export function installBundledSkills() {
    ...
    for (const skillName of skillDirs) {
        ...
        try {
            ...
            console.error(`[skillsmith] Failed to install ${skillName}:`, error instanceof Error ? error.message : 'Unknown error');
        }
    }
    return installed;
}
 ...
 */
export function installUserDocs() {
    ...
    try {
        ...
        console.error('[skillsmith] Failed to install docs:', error instanceof Error ? error.message : 'Unknown error');
        return false;
    }
}
/**
 ...
 */
export function getUserGuidePath() {
