...
import { skillInventoryAudit, skillInventoryAuditToolSchema, } from './tools/skill-inventory-audit.js';
import { applyNamespaceRename, applyNamespaceRenameToolSchema, } from './tools/apply-namespace-rename.js';
import { applyRecommendedEditTool, applyRecommendedEditToolSchema, } from './tools/apply-recommended-edit.js';
import { undoApply, undoApplyToolSchema } from './tools/undo-apply.js';
import { applyManifestReconcile, applyManifestReconcileToolSchema, } from './tools/apply-manifest-reconcile.js';
 ...
 */
export const AUDIT_TOOL_NAMES = new Set(buildAuditToolNames());
 ...
 */
export function isAuditToolName(name) {
 ...
 */
export async function dispatchAuditTool(name, args, toolContext, licenseMiddleware, quotaMiddleware) {
    switch (name) {
        case 'skill_audit':
            return withLicenseAndQuota('skill_audit', args, skillAuditInputSchema, executeSkillAudit, toolContext, licenseMiddleware, quotaMiddleware);
        case 'skill_pack_audit':
            return withLicenseAndQuota('skill_pack_audit', args, skillPackAuditInputSchema, executeSkillPackAudit, toolContext, licenseMiddleware, quotaMiddleware);
...
//# sourceMappingURL=audit-tool-dispatch.js.map