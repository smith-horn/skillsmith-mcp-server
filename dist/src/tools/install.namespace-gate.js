...
import { isAuditMode } from '@skillsmith/core/config/audit-mode';
import { CLAUDE_SKILLS_DIR } from './install.types.js';
 ...
 */
export function buildPreflightCandidate(skillId) {
