 ...
 * scope.
 */
export async function listSkills(client, teamId, version, includeDeprecated) {
    let query = client
        .from(TABLE)
 ...
 */
export async function getSkill(client, teamId, skillId, version) {
    if (version) {
...
//# sourceMappingURL=registry-tools.live.reads.js.map