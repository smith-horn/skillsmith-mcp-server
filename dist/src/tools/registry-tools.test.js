...
describe('registry-tools', () => {
    ...
    describe('privateRegistryPublishInputSchema', () => {
        ...
        it('should reject invalid skill ID format', () => {
            expect(() => privateRegistryPublishInputSchema.parse({ skillId: 'no-slash', version: '1.0.0' })).toThrow();
        });
    ...
    describe('executePrivateRegistryManage', () => {
        ...
        it('should list published skills', async () => {
            ...
            await executePrivateRegistryPublish({ skillId: 'myteam/skill-a', version: '1.0.0' }, mockContext);
        ...
        it('should deprecate a skill', async () => {
            await executePrivateRegistryPublish({ skillId: 'myteam/old-skill', version: '1.0.0' }, mockContext);
        ...
        it('should undeprecate a skill', async () => {
            await executePrivateRegistryPublish({ skillId: 'myteam/revived', version: '2.0.0' }, mockContext);
