    ...
    if (!conflictAction) {
        ...
        return {
            ...
            earlyReturn: {
                ...
                requiresAction: ['overwrite', 'merge', 'cancel'],
                tips: [
...
export async function handleMergeAction(skillName, installPath, upstreamContent, manifest, owner, repo, skillId) {
    ...
    if (!originalContent) {
        ...
        console.warn('[install] No original content found for merge, falling back to overwrite for: ' + skillName);
        return { shouldProceed: true };
    }
...
//# sourceMappingURL=install.conflict.js.map