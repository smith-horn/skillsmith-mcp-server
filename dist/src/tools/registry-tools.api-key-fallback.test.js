...
import { executePrivateRegistryManage, executePrivateRegistryPublish, createStubRegistryService, setPrivateRegistryService, } from './registry-tools.js';
const rpcMock = vi.fn();
...
function isolateCredentialEnv() {
    ...
    return () => {
        if (origLicense === undefined)
            delete process.env.SKILLSMITH_LICENSE_KEY;
        else
            process.env.SKILLSMITH_LICENSE_KEY = origLicense;
...
//# sourceMappingURL=registry-tools.api-key-fallback.test.js.map