...
export declare const GRANTABLE_ROLES: readonly GrantableRole[];
/**
 ...
 */
export type TeamPermission = 'registry:approve' | 'registry:deprecate' | 'team:manage_rbac' | 'team:manage_sso';
export declare const TEAM_PERMISSIONS: readonly TeamPermission[];
/** The meta-permission every write in this module is gated on. */
export declare const MANAGE_RBAC_PERMISSION: TeamPermission;
/**
 ...
 */
export declare const META_PERMISSIONS: readonly TeamPermission[];
 ...
 */
export declare const DEFAULT_ROLE_PERMISSIONS: Readonly<Record<GrantableRole, Readonly<Record<TeamPermission, PermissionEffect>>>>;
...
export interface RBACService {
    ...
    setRolePermission(teamId: string, role: GrantableRole, permission: TeamPermission, effect: PermissionEffect): Promise<void>;
    /**
     ...
     */
    resetRolePermission(teamId: string, role: GrantableRole, permission: TeamPermission): Promise<boolean>;
 ...
 */
export declare function resolveEffectivePermission(role: GrantableRole, permission: TeamPermission, grant: PermissionEffect | undefined): EffectivePermission;
