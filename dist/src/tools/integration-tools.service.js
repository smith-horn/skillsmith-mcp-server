...
// Row mappers
// ============================================================================
function rowToWebhookMasked(row) {
...
function rowToApiKeyMasked(row) {
 ...
 */
export function createRealIntegrationService(supabase, teamId) {
    // Rate limiting for test delivery (per webhook, in-memory)
    const testDeliveryTimestamps = new Map();
    return {
        // ========================================================================
        // Webhooks
        // ========================================================================
        ...
        async getWebhook(webhookId) {
            ...
            if (error || !data)
                return null;
            return rowToWebhookMasked(data);
        },
...
//# sourceMappingURL=integration-tools.service.js.map