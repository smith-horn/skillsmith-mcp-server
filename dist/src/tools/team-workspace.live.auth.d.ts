 ...
 */
export declare function getWorkspaceManageUserClient(operation: string): Promise<WorkspaceUserClientBinding>;
/**
 ...
 */
export declare function getWorkspaceMemberUserClient(operation: string): Promise<WorkspaceUserClientBinding>;
//# sourceMappingURL=team-workspace.live.auth.d.ts.map