 ...
 */
export function localSkillToSearchResult(skill) {
    return {
        id: skill.id,
        name: skill.name,
 ...
 */
export async function searchLocalSkills(query, filters, quarantineRepo) {
    ...
    let matchingSkills = query ? indexer.search(query, localSkills) : localSkills;
...
//# sourceMappingURL=LocalSkillSearch.js.map