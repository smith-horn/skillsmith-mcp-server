...
const ROLE_ENUM_VALUES = GRANTABLE_ROLES;
const PERMISSION_ENUM_VALUES = TEAM_PERMISSIONS;
...
export const rbacManageToolSchema = {
    name: 'rbac_manage',
    description: 'Inspect and configure team role permissions: list_roles, get_role, set_role_permission, ' +
...
export const rbacCreatePolicyToolSchema = {
    ...
    description: 'Bulk-write or clear permission overrides: create expands resources x actions into ' +
...
//# sourceMappingURL=rbac-tools.schemas.js.map