 ...
 */
import { mapTrustTierFromDb, extractCategoryFromTags, normalizeApiCategory, } from '../utils/validation.js';
 ...
 */
export function generateDifferences(skillA, skillB) {
    const differences = [];
 ...
 */
export function generateRecommendation(skillA, skillB, differences) {
    // Count wins
    let aWins = 0;
    let bWins = 0;
 ...
 */
export function dbSkillToExtended(dbSkill) {
 ...
 */
export function apiSkillToExtended(apiSkill) {
 ...
 */
export function formatScoreBar(score, width) {
