...
export async function auditedList(teamId, version, includeDeprecated) {
 ...
 */
export async function auditedGet(teamId, skillId, version) {
    let actorUserId = null;
    try {
...
export async function auditedGetNamespace(teamId) {
    let actorUserId = null;
    try {
...
//# sourceMappingURL=registry-tools.live.member-reads.js.map