 ...
 */
const SCAN_COVERAGE_CAUSE_PROSE = {
...
export function formatScanCoverageNote(note) {
    return note
        .split('; ')
...
export function formatScanCoverageCaveat(scanCoverageIncomplete, scanCoverageNote) {
    if (scanCoverageIncomplete !== true)
        return null;
    return ('Note: partial scan — some files could not be analyzed' +
        (scanCoverageNote ? ' (' + formatScanCoverageNote(scanCoverageNote) + ')' : ''));
}
//# sourceMappingURL=scan-coverage.format.js.map