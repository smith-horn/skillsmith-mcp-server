...
export const applyRecommendedEditToolSchema = {
    ...
    inputSchema: {
        ...
        properties: {
            ...
            confirmed: {
                type: 'boolean',
                description: 'When true, performs the prose edit. When omitted/false, returns a non-mutating preview. Defaults to false.',
            },
        },
 ...
 * shape.
 */
async function applyRecommendedEditToolImpl(input) {
...
//# sourceMappingURL=apply-recommended-edit.js.map