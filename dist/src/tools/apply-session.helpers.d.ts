...
export declare function recordSessionApply(entry: SessionAppliedChangeset): void;
/** Read-only snapshot, most-recent-last (matches internal storage order). */
export declare function listSessionApplies(): readonly SessionAppliedChangeset[];
/** Remove one entry by reference identity. No-op if not present (e.g.
 * already removed by a prior undo). */
export declare function removeSessionApply(entry: SessionAppliedChangeset): void;
/** Test-only reset — mirrors `resetJournalSessionIdForTests` in
 * `@skillsmith/core/journal`. */
export declare function resetSessionAppliesForTests(): void;
/**
 ...
 */
export declare function selectUndoTargets(opts: {
    count?: number;
    suggestionId?: string;
 ...
 */
export declare function resolveBackupFileName(backupRef: string, targetPath: string): Promise<string | null>;
//# sourceMappingURL=apply-session.helpers.d.ts.map