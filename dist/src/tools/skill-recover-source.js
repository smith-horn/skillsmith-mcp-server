...
import { z } from 'zod';
import { SourceRecoveryService, defaultSkillsRoot, parseRepoUrl, skillNameVariants, } from '@skillsmith/core';
import { withTelemetry } from '@skillsmith/core/telemetry';
import { hashContent } from './install.conflict-helpers.js';
// ============================================================================
// homeDir refinement (mirrors skill-inventory-audit.ts:165)
// ============================================================================
export function isHomeDirUnderAllowedRoot(value) {
...
export const skillRecoverSourceToolSchema = {
    ...
    description: '[Skillsmith — Maintain stage] Recover the canonical GitHub source of ' +
    ...
    inputSchema: {
        ...
        properties: {
            homeDir: {
                type: 'string',
                description: 'Override the skills root parent. Must resolve under os.homedir() or os.tmpdir(); ' +
...
async function findCandidatesOnline(context, name) {
    try {
...
function findCandidatesOffline(context, name) {
 ...
 */
function findRegistryIdByRepoUrlOffline(context, repoUrl) {
...
// Tool implementation
// ============================================================================
async function skillRecoverSourceImpl(input, context) {
    ...
    const findRegistryIdByRepoUrl = async (repoUrl) => findRegistryIdByRepoUrlOffline(context, repoUrl);
...
//# sourceMappingURL=skill-recover-source.js.map