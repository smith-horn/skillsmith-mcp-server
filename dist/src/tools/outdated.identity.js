 ...
 * has zero renderers).
 */
import { classifyOutdatedState, } from '@skillsmith/core';
...
export function deriveUnknownReason(params) {
    if (params.liveArmOffline)
        return 'offline';
    if (params.quotaExhausted)
    ...
    switch (state) {
        ...
        case 'outdated':
            ...
            return {
                ...
                remediation: 'Preview with `skillsmith update <name> --dry-run`, then update this skill on its own.',
        ...
        case 'local-drift':
            return {
                ...
                signal: null,
                inconclusiveReason: null,
                summary: 'On-disk content differs from the registry, and nothing contradicts the recorded ' +
                    'identity — this looks like a local edit.',
                remediation: 'Excluded from bulk update to protect the local edit. Update this one explicitly if ' +
        ...
        case 'identity-mismatch':
            return {
                ...
                signal,
                inconclusiveReason: null,
                summary: "This entry's recorded identity contradicts what is on disk — the recorded id/source " +
                    'may name an unrelated skill.',
                remediation: 'Run `skill_recover_source` for evidence, then `apply_manifest_reconcile` with ' +
        ...
        case 'unknown': {
            ...
            const remediation = reason === 'no-registry-record'
...
//# sourceMappingURL=outdated.identity.js.map