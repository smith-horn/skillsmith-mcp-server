 ...
 */
export async function executeRegistrySubmissions(params) {
    ...
    return {
        ...
        dataSource,
        submissions,
        message: `Found ${submissions.length} submission(s) visible to you. Metadata only — provenance ` +
 ...
 */
export async function executeRegistryReview(params) {
    const { input, teamId, dataSource, service } = params;
...
//# sourceMappingURL=registry-tools.review-action.js.map