 ...
 */
export function validateSkillPath(skillPath) {
 ...
 */
export function checkGhPreflight() {
 ...
 */
export async function scanReferences(dirPath, customPatterns) {
    const allWarnings = [];
 ...
 */
export async function writeManifest(dirPath, manifest) {
 ...
 */
export function createGitHubRepo(name, visibility) {
    try {
 ...
 */
export function addClaudeSkillTopic(repoName) {
    try {
 ...
 */
export function formatPublishResults(success, metadata, referenceWarnings, nextSteps, repoUrl, error) {
    const lines = [];
