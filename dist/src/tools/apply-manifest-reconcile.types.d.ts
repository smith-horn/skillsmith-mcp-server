 ...
 */
export type ManifestReconcileErrorCode = 'manifest.reconcile.invalid_input' | 'manifest.reconcile.entry_not_found' | 'manifest.reconcile.key_shape_ambiguous' | 'manifest.reconcile.relink_unvalidated' | 'manifest.reconcile.relink_incomplete' | 'manifest.reconcile.drop_target_still_resolves' | 'manifest.reconcile.backup_target_not_a_file' | 'manifest.reconcile.backup_failed' | 'manifest.reconcile.lock_timeout' | 'manifest.reconcile.entry_changed' | 'manifest.reconcile.revert_ambiguous' | 'manifest.reconcile.ledger_version_unsupported' | 'manifest.reconcile.ledger_malformed' | 'manifest.reconcile.verify_unavailable';
...
//# sourceMappingURL=apply-manifest-reconcile.types.d.ts.map