 ...
 */
export declare function getSsoManageUserClient(operation: string): Promise<SsoUserAuthBinding>;
/**
 ...
 */
export declare function getSsoReadUserClient(operation: string): Promise<SsoUserAuthBinding>;
//# sourceMappingURL=sso-tools.live.auth.d.ts.map