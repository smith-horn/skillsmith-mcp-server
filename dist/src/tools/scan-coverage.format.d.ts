...
export declare function formatScanCoverageNote(note: string): string;
/** The standard partial-scan caveat line, or `null` when coverage was complete. */
export declare function formatScanCoverageCaveat(scanCoverageIncomplete: boolean | undefined, scanCoverageNote: string | null | undefined): string | null;
//# sourceMappingURL=scan-coverage.format.d.ts.map