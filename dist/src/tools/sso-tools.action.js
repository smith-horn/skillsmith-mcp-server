        ...
        switch (input.action) {
            case 'set': {
                ...
                if (!input.domain) {
                    return {
                        success: false,
                        dataSource,
                        error: 'domain is required for action "set" — claim and verify a domain first ' +
            ...
            case 'claim_domain': {
                ...
                return {
                    ...
                    dataSource,
                    domainClaim: claim,
                    message: `To verify ownership of \`${claim.domain}\`, publish this DNS TXT record:\n\n` +
...
//# sourceMappingURL=sso-tools.action.js.map