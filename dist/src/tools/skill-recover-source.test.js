...
vi.mock('@skillsmith/core', async (importOriginal) => {
    ...
    return {
        ...
        SourceRecoveryService: function MockSourceRecoveryService() {
            return { recoverSources: (...args) => mockRecoverSources(...args) };
        },
...
// Imports after mocks
// ============================================================================
import { skillRecoverSourceInputSchema, isHomeDirUnderAllowedRoot, executeSkillRecoverSource, } from './skill-recover-source.js';
// ============================================================================
// Helpers
// ============================================================================
...
describe('executeSkillRecoverSource', () => {
    ...
    it('returns skills and summary on happy path', async () => {
        ...
        const result = (await executeSkillRecoverSource({}, ctx));
    ...
    it('passes homeDir-derived skillsRoot to recoverSources', async () => {
        ...
        expect(mockRecoverSources).toHaveBeenCalledWith(expect.objectContaining({ skillsRoot: expect.stringContaining('.claude') }));
    });
    ...
    it('throws on invalid input (homeDir: /etc)', async () => {
        const ctx = makeContext();
        await expect(executeSkillRecoverSource({ homeDir: '/etc' }, ctx)).rejects.toThrow(/Invalid skill_recover_source input/);
    });
});
//# sourceMappingURL=skill-recover-source.test.js.map