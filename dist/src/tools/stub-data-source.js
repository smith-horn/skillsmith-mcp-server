 ...
 */
const stubInstances = new WeakSet();
/**
 ...
 */
export function dataSourceFor(service) {
    return isStubService(service) ? 'stub' : 'live';
}
//# sourceMappingURL=stub-data-source.js.map