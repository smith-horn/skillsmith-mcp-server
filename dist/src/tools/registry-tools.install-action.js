 ...
 */
function defaultInstaller(context) {
 ...
 */
export async function executeRegistryInstall(params) {
    ...
    return {
        ...
        dataSource,
        install,
        message: `Installed ${fetched.skillId}@${fetched.version} from the private registry to ` +
            `${result.installPath}.`,
    };
}
//# sourceMappingURL=registry-tools.install-action.js.map