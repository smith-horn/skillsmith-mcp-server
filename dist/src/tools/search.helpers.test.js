...
import { compatibilityWantedSlugs, computeCompatRank, sortByCompatRank, countCompatDeprioritized, mergeRankAndPage, filterInstallable, resolveDefaultCompatibility, buildEmptySearchSuggestion, mapLocalSkillToSearchResult, computeLocalCompatFetchLimit, } from './search.helpers.js';
...
describe('countCompatDeprioritized (SMI-5929)', () => {
    ...
    it('reflects only what was passed in — the field it backs is page-scoped, not corpus-wide', () => {
        const wide = sortByCompatRank([skill('rank0', ['windsurf']), skill('rank2-a', ['copilot']), skill('rank2-b', ['gemini'])], { ides: ['windsurf'] });
