...
import { buildCoverageNote, nicknameFromActor, actorDisplayLabel, } from './analytics.supabase.service.js';
// ============================================================================
...
function mockUserClient(resolvedValue) {
    const { client, rpc } = createMockSupabase(resolvedValue);
    mockGetUserClient.mockResolvedValue(client);
    return { client, rpc };
}
// ============================================================================
// getTopSkills
...
describe('buildCoverageNote', () => {
    ...
    it('never renders the literal string "null" for any combination of null buckets at any level', () => {
        const levels = ['full', 'aggregate', 'qualitative'];
        const bucketKeys = [
            'totalSeats',
            'reportingSeats',
            'nonReportingSeats',
