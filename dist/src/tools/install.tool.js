...
export const installTool = {
    ...
    inputSchema: {
        ...
        properties: {
            ...
            cwd: {
                type: 'string',
                description: "Absolute path to the calling client's actual project/workspace root, used to " +
            ...
            scope: {
                ...
                description: 'Install scope (ADR-139): "workspace" resolves against the nearest ancestor workspace ' +
