 ...
 * scope.
 */
export declare function listSkills(client: MinimalSupabaseClient, teamId: string, version?: string, includeDeprecated?: boolean): Promise<RegistrySkill[]>;
/**
 ...
 */
export declare function getSkill(client: MinimalSupabaseClient, teamId: string, skillId: string, version?: string): Promise<RegistrySkill | null>;
//# sourceMappingURL=registry-tools.live.reads.d.ts.map