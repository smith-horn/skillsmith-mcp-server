...
export interface PrivateRegistryReviewService {
    ...
    submissions(teamId: string, status?: 'pending' | 'approved' | 'rejected'): Promise<RegistrySkill[]>;
    ...
    review(teamId: string, skillId: string, version: string, decision: 'approved' | 'rejected', note?: string): Promise<RegistryReviewDecision>;
}
//# sourceMappingURL=registry-tools.review.types.d.ts.map