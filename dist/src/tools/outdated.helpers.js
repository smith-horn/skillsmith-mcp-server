 ...
 * second file read.
 */
export async function readInstalledContent(installPath) {
 ...
 */
export function checkDependencies(deps, installedSkillIds) {
    const satisfied = [];
    const missing = [];
...
//# sourceMappingURL=outdated.helpers.js.map