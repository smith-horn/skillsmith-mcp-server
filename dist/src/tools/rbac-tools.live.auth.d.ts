 ...
 */
export declare function getRbacManageUserClient(operation: string): Promise<RbacUserClientBinding>;
/**
 ...
 */
export declare function getRbacReadUserClient(operation: string): Promise<RbacUserClientBinding>;
//# sourceMappingURL=rbac-tools.live.auth.d.ts.map