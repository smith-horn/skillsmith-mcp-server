 ...
 */
function describeClientBindFailure(operation) {
    switch (operation) {
        case 'submissions':
...
async function bindUserClient(role, operation, noUserMessage) {
 ...
 */
export async function getAdminUserClient(operation) {
    return bindUserClient('admin', operation, `Only team admins can ${operation} a private-registry skill, so this operation needs a ` +
 ...
 */
export async function getMemberUserClient(operation) {
    return bindUserClient('member', operation, `A private-registry ${operation} runs as you, not as your team's shared license key — a ` +
...
//# sourceMappingURL=registry-tools.live.auth.js.map