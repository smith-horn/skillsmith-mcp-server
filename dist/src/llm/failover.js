 ...
 * ```
 */
import { createMultiLLMProvider, } from '@skillsmith/core/testing';
/**
 * Default configuration for MCP server LLM failover
 * Tuned for SMI-1524 acceptance criteria
 */
export const DEFAULT_LLM_FAILOVER_CONFIG = {
    enabled: true,
    ...
    constructor(config = {}) {
        ...
        this.config = {
            ...
            circuitBreaker: {
                ...
                resetTimeoutMs: config.circuitResetTimeoutMs ?? DEFAULT_LLM_FAILOVER_CONFIG.circuitResetTimeoutMs,
                volumeThreshold: config.circuitOpenThreshold ?? DEFAULT_LLM_FAILOVER_CONFIG.circuitOpenThreshold,
 ...
 */
export async function createLLMFailoverChain(config = {}) {
