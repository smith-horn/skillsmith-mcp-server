...
describe('Context Module', () => {
    ...
    describe('createToolContextAsync', () => {
        describe('basic initialization', () => {
            ...
            it('should throw error for invalid custom path', async () => {
                await expect(createToolContextAsync({ dbPath: '/etc/malicious/../../../root/hack.db' })).rejects.toThrow('Invalid database path');
            });
    ...
    describe('getToolContextAsync (singleton)', () => {
        ...
        it('should not warn when no options provided on subsequent calls', async () => {
            ...
            const optionsIgnoredCalls = consoleWarnSpy.mock.calls.filter((args) => typeof args[0] === 'string' && args[0].includes('Options ignored'));
