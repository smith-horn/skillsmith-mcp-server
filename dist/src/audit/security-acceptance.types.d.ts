...
export declare function emptyAcceptanceStore(): AcceptanceStore;
export type AcceptanceWarningCode = 'acceptance_records_malformed' | 'acceptance_records_over_capacity' | 'acceptance_records_ruleset_expired' | 'acceptance_store_unreadable' | 'acceptance_store_oversized' | 'acceptance_store_digest_mismatch' | 'acceptance_store_write_failed' | 'acceptance_store_foreign_revision';
...
//# sourceMappingURL=security-acceptance.types.d.ts.map