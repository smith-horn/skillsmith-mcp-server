...
import { buildSummary, fsErr, pathExists, resolveRenameTarget, } from './rename-engine.apply-paths.js';
 ...
 */
export async function revertRename(suggestion, auditId, collisionId) {
...
//# sourceMappingURL=rename-engine.revert.js.map