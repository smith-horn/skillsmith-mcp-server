...
export class LocalIndexer {
     ...
     */
    constructor(skillsDir, cacheTtl = 60000) {
     ...
     */
    calculateQualityScore(frontmatter, hasSkillMd) {
        let score = 0;
     ...
     */
    indexSkillDir(skillDir, _dirName) {
        try {
            ...
            console.warn('[LocalIndexer] Failed to read skill directory:', skillDir, error instanceof Error ? error.message : String(error));
            return null;
        }
    }
    /**
    ...
    _performIndex(force) {
        ...
        try {
            ...
            console.warn('[LocalIndexer] Failed to read skills directory:', this.skillsDir, error instanceof Error ? error.message : String(error));
        }
 ...
 */
function parseFrontmatterAdapter(content) {
 ...
 */
export function getLocalIndexer() {
    if (!defaultIndexer) {
 ...
 */
export function resetLocalIndexer() {
    defaultIndexer = null;
}
//# sourceMappingURL=LocalIndexer.js.map